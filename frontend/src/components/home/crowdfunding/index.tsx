        ...
        <Stack direction={{ base: "column", md: "row" }} spacing={8} h="100%">
          <Flex flexDir="column" w="full" maxW={{ lg: "648px" }}>
            ...
            <Text mt="10" textStyle="p">
              Com mais de 1000 investidores que decidiram apoiar esse movimento,
              o AppJusto superou em 130% a meta de financiamento estabelecida,
              possibilitando que nossa proposta alcance ainda mais pessoas no
              futuro. Muito obrigado a todos os que participaram dessa conquista
              conosco ❤️
            </Text>
            <CustomLinkButton
              mt="8"
